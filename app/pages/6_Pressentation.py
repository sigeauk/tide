...
st.set_page_config(page_title="TIDE Ecosystem", page_icon="app/static/icons/tide.png", layout="wide")
apply_custom_styles()
require_auth()
...
nodes = {
    "feeds":   {"label": "Threat<br>&nbsp;  Feeds", "img": "feeds.png", "emoji": "📡", "top": "60%", "left": "10%",  "color": "#94a3b8"},
    "mitre":   {"label": "MITRE", "img": "icons/mitre.png", "emoji": "🎯", "top": "12%", "left": "60%", "color": "#f43f5e"},
    "opencti": {"label": "OpenCTI", "img": "icons/opencti.png", "emoji": "🧠", "top": "33%", "left": "30%", "color": "#150aee"},
    "sigma":   {"label": "Sigma", "img": "icons/sigma.png", "emoji": "📜", "top": "85%", "left": "30%", "color": "#aeba29"},
    "elastic": {"label": "Elastic", "img": "icons/elastic.png", "emoji": "⚡", "top": "60%", "left": "60%", "color": "#12dd5c"},
    "gitlab":  {"label": "GitLab", "img": "icons/gitlab.png", "emoji": "🦊", "top": "85%", "left": "90%", "color": "#f97316"},
    "tide":    {"label": "TIDE", "img": "icons/tide.png", "emoji": "🌊", 	"top":"33%","left":"90%","color":"#aeba29"},
}
...
<script>
    ...
    Object.keys(NODES).forEach(key => {{
        ...
        const imgSrc = STATIC_PATH + '/' + n.img;
        ...
        if (img.complete && img.naturalHeight === 0) {{
             ...
             el.querySelector('.node-emoji').style.display = 'block';
        }}
    }});
